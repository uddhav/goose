...
export const goose_models: Model[] = [
  ...
  { id: 20, name: 'claude-3-5-sonnet-v2@20241022', provider: 'GCP Vertex AI' },
  { id: 21, name: 'claude-3-5-sonnet@20240620', provider: 'GCP Vertex AI' },
  { id: 22, name: 'gemini-1.5-pro-002', provider: 'GCP Vertex AI' },
  { id: 23, name: 'gemini-2.0-flash-001', provider: 'GCP Vertex AI' },
...
export const default_models = {
  ...
  ollama: 'qwen2.5',
  azure_openai: 'gpt-4o',
  gcp_vertex_ai: 'claude-3-5-sonnet-v2@20241022',
};
